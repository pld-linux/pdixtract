...
Summary(pl.UTF-8):   Konwersja obrazów dysków Pinnacle do ISO9660 i wyciąganie plików
Name:		pdixtract
Version:	1.5
Release:	1
License:	GPL
...
Narzędzie do konwersji obrazów dysków Pinnacle (zbiorów plików .pdi,
czyli Pinnacle Disk Images) do plików ISO9660 oraz wyciągania plików
ze zbiorów plików.
